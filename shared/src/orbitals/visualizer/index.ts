/**
 * Almadar State Machine Visualizer
 *
 * Renders SVG diagrams from Almadar schemas and Trait definitions.
...
import {
    ...
    isArraySExpr,
} from '../../domain-language/formatters/sexpr-formatter.js';
...
/**
 * Extract state machine from various data formats (Trait, Almadar, or raw)
 */
