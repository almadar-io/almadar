...
export type MenuPosition =
  ...
  | 'top-start' | 'top-end' | 'bottom-start' | 'bottom-end'; // Aliases for pattern compatibility
...
export const Menu: React.FC<MenuProps> = ({
  ...
  const triggerChild = React.isValidElement(trigger) ? trigger : <span>{trigger}</span>;

  const triggerElement = React.cloneElement(triggerChild as React.ReactElement<any>, {
    ref: triggerRef,
  ...
  const renderMenuItem = (item: MenuItem, hasSubMenu: boolean, index: number) => {
