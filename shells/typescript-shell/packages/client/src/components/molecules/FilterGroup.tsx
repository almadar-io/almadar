...
export const FilterGroup: React.FC<FilterGroupProps> = ({
    ...
    const handleFilterSelect = useCallback((field: string, value: string | null) => {
            ...
            <HStack gap="md" align="center" className={cn('flex-wrap', className)}>
                ...
                {filters.map((filter) => (
                    <HStack key={filter.field} gap="xs" align="center">
                        ...
                        <HStack gap="none" className="rounded-[var(--radius-sm)] overflow-hidden border-[length:var(--border-width)] border-[var(--color-border)]">
                            <button
                                type="button"
                ...
                {filters.map((filter) => (
                    <div key={filter.field} className="flex flex-col gap-1">
                        ...
                        {filter.filterType === 'date' ? (
                            ...
                            />
                        ) : (filter.filterType === 'daterange' || filter.filterType === 'date-range') ? (
                            <div className="flex flex-col gap-2">
                                <Input
                                    type="date"
                                    value={selectedValues[`${filter.field}_from`] || ''}
                                    onChange={(e) => handleFilterSelect(`${filter.field}_from`, e.target.value || null)}
                                    placeholder="From"
                                    clearable
                                ...
                                <Input
                                    ...
                                    onChange={(e) => handleFilterSelect(`${filter.field}_to`, e.target.value || null)}
                                    placeholder="To"
                                    clearable
