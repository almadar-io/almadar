...
const variantClasses: Record<ToastVariant, string> = {
  success: 'bg-[var(--color-card)] border-[length:var(--border-width)] border-emerald-600',
  error: 'bg-[var(--color-card)] border-[length:var(--border-width)] border-red-600',
  info: 'bg-[var(--color-card)] border-[length:var(--border-width)] border-blue-600',
  warning: 'bg-[var(--color-card)] border-[length:var(--border-width)] border-amber-500',
};
    ...
    >
      <div className="flex items-start gap-3">
        <div className="flex-shrink-0 mt-0.5">
          <Icon icon={iconMap[variant]} size="md" className={iconColors[variant]} />
        </div>
