 ...
 */
function convertElementsToStats(elements: readonly GameHudElement[]): GameHudStat[] {
...
export function GameHud({
  ...
  // Convert elements to stats if provided
  const stats = propStats ?? (elements ? convertElementsToStats(elements) : []);
