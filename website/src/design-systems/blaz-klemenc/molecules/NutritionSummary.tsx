  ...
  return (
    <Card className={cn("p-4", className)}>
      <VStack gap="md">
        ...
        {/* Calories */}
        <Box rounded="lg" padding="md" className="bg-orange-500/10">
          <HStack justify="between" align="center">
            <HStack gap="sm" align="center">
          ...
          {targets && percentages && (
            <Box rounded="full" className="h-2 w-full mt-2 bg-orange-500/15">
              <Box
                rounded="full"
        ...
        {summary.protein + summary.carbs + summary.fat > 0 && (
          <VStack gap="xs">
            ...
            <Box
              rounded="full"
              className="h-3 w-full overflow-hidden bg-[var(--color-muted)]"
            >
