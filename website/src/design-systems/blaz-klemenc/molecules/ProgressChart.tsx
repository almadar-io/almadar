      ...
      <VStack gap="md">
        ...
        <Box className="relative" style={{ height: chartHeight + 20 }}>
          {filteredData.length > 0 ? (
            ...
            <Box className="h-full flex items-center justify-center text-[var(--color-muted-foreground)]">
        ...
        {/* Stats Row */}
        <HStack justify="between" className="border-t border-[var(--color-border)] pt-3">
