      ...
      <VStack key={field.key} gap="xs">
        ...
        <HStack gap="sm" align="center">
          <Input
            ...
            className="flex-1"
          />
          <Typography variant="small" className="text-[var(--color-muted-foreground)] w-8">
            {field.unit}
          </Typography>
        </HStack>
      </VStack>
      ...
      <VStack gap="lg">
        ...
        <HStack justify="between" align="center">
          <HStack gap="sm" align="center">
            <Box
              ...
              rounded="lg"
              padding="sm"
              className="items-center justify-center bg-teal-500/15"
            >
        ...
        <VStack gap="xs">
          ...
          <textarea
            ...
            className="w-full min-h-[80px] p-3 border border-[var(--color-border)] rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-teal-500"
          />
        </VStack>

        {/* Action Buttons */}
        <HStack gap="sm" justify="end" className="border-t border-[var(--color-border)] pt-4">
