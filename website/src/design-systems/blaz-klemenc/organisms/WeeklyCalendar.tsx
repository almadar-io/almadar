...
const eventTypeColors = {
  personal: "bg-blue-500/100/15 border-blue-500/30 text-blue-600",
  group: "bg-purple-500/15 border-purple-500/30 text-purple-600",
  break: "bg-[var(--color-muted)] border-[var(--color-border)] text-[var(--color-muted-foreground)]",
};
              ...
              {weekDays.map((day) => {
                ...
                return (
                  <Box
                    key={day.toISOString()}
                    className={cn(
                      "p-2 text-center cursor-pointer hover:bg-[var(--color-muted)] border-l",
                  ...
                  {weekDays.map((day) => {
                    ...
                    return (
                      <Box
                        ...
                        className={cn(
                          "p-1 min-h-[60px] border-l cursor-pointer hover:bg-[var(--color-muted)] transition-colors",
