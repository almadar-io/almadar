...
export const WithAIAnalysis: Story = {
  args: {
    entity: { items: sampleMealPlans.filter((mp) => mp.aiAnalysis) },
...
export const HighCalorie: Story = {
  args: {
    entity: { items: sampleMealPlans.filter((mp) => (mp.calories || 0) >= 2400) },
...
export const LowCalorie: Story = {
  args: {
    entity: { items: sampleMealPlans.filter((mp) => (mp.calories || 0) < 2000) },
    title: "Deficit Plans",
