...
export const ScheduledOnly: Story = {
  args: {
    entity: { items: sampleSessions.filter((s) => s.status === "scheduled") },
...
export const CompletedOnly: Story = {
  args: {
    entity: { items: sampleSessions.filter((s) => s.status === "completed") },
...
export const InProgressOnly: Story = {
  args: {
    entity: { items: sampleSessions.filter((s) => s.status === "in-progress") },
