      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            ...
            <button onClick={() => onDismiss(id)} className="flex-shrink-0 p-1 rounded hover:bg-[var(--color-secondary)] transition-colors" aria-label="Dismiss">
      ...
      >
        <div className="flex items-center justify-between px-4 py-3 border-b border-[var(--color-border)]">
          ...
          <div className="flex items-center gap-1">
            ...
            <button onClick={onClose} className="p-2 rounded-lg hover:bg-[var(--color-secondary)] transition-colors" aria-label="Close">
        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-2">
          {notifications.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center py-8">
              <Bell className="w-12 h-12 text-[var(--color-muted-foreground)] mb-3" />
