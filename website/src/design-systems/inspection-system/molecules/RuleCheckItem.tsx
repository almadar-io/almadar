              ...
              <button
                ...
                className={cn(
                  ...
                  localCompliant === true
                    ...
                    : "bg-neutral-50 border-neutral-200 text-[var(--color-muted-foreground)] hover:bg-green-50",
                )}
              >
              ...
              <button
                ...
                className={cn(
                  ...
                  localCompliant === false
                    ...
                    : "bg-neutral-50 border-neutral-200 text-[var(--color-muted-foreground)] hover:bg-red-50",
                )}
              >
                <X className="h-5 w-5" />
              </button>
