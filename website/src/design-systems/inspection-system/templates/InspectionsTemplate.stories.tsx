...
import { InspectionsTemplate, InspectionEntity } from "./InspectionsTemplate";
...
const sampleInspections: InspectionEntity[] = [
  {
    id: "insp-1",
...
export const PreparationOnly: Story = {
  args: {
    entity: sampleInspections.filter((i) => i.phase === "preparation"),
...
export const InProgressOnly: Story = {
  args: {
    entity: sampleInspections.filter((i) => i.phase === "execution" || i.phase === "documentation"),
...
export const CompletedOnly: Story = {
  args: {
    entity: sampleInspections.filter((i) => i.phase === "completed"),
