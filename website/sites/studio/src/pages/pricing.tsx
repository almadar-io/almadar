...
const TIERS = [
  {
    ...
    features: ["3 projects", "AI agent access", "Live preview", "Community support"],
  ...
  },
  {
    ...
    features: ["Unlimited projects", "Priority AI generation", "One-click deploy", "Custom domains", "Email support"],
