#!/usr/bin/env python3
"""Generate logo variations from the source almadar-logo.jpeg"""
...
SOURCE = WEBSITE_ROOT / "static" / "brand" / "logos" / "almadar-logo.jpeg"
...
# 1. Main logo (PNG, high quality)
print("Creating main logo...")
src.save(f"{LOGOS_DIR}/almadar-logo.png", "PNG", quality=95)
...
icon_square.save(f"{LOGOS_DIR}/almadar-icon.png", "PNG")

# 3. Icon sizes for various uses
...
for icon_size in [512, 256, 192, 180, 128, 64, 32, 16]:
    ...
    icon_resized.save(f"{LOGOS_DIR}/almadar-icon-{icon_size}.png", "PNG")

# 4. Apple touch icon (180x180)
print("Creating Apple touch icon...")
apple_icon = icon_square.resize((180, 180), Image.Resampling.LANCZOS)
apple_icon.save(f"{LOGOS_DIR}/apple-touch-icon.png", "PNG")

# 5. Favicon (32x32 and 16x16 in ICO format)
print("Creating favicon...")
favicon_32 = icon_square.resize((32, 32), Image.Resampling.LANCZOS)
favicon_16 = icon_square.resize((16, 16), Image.Resampling.LANCZOS)
favicon_32.save(f"{LOGOS_DIR}/favicon.ico", format="ICO", sizes=[(16, 16), (32, 32)])

# 6. Monochrome version (grayscale)
print("Creating monochrome version...")
mono = ImageOps.grayscale(src)
mono.save(f"{LOGOS_DIR}/almadar-logo-mono.png", "PNG")

# 7. Dark mode version (inverted/lightened for dark backgrounds)
...
dark_version.save(f"{LOGOS_DIR}/almadar-logo-dark.png", "PNG")

# === SOCIAL MEDIA BANNERS ===

# Twitter/X banner: 1500x500
print("Creating Twitter banner...")
...
twitter_banner.save(f"{SOCIAL_DIR}/twitter-banner.png", "PNG")

# LinkedIn banner: 1584x396
print("Creating LinkedIn banner...")
...
linkedin_banner.save(f"{SOCIAL_DIR}/linkedin-banner.png", "PNG")
...
og_image.save(f"{SOCIAL_DIR}/og-image.png", "PNG")

# Twitter card: 1200x600
print("Creating Twitter card...")
...
twitter_card.save(f"{SOCIAL_DIR}/twitter-card.png", "PNG")
