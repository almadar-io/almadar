...
المكوّن يُعاد تصييره بناءً على الحالة الجديدة. النافذة المنبثقة تختفي لأن الـ state machine قالت ذلك.
...
الغلاف يُرسل الحدث. الـ state machine تتعامل معه. الدائرة تكتمل.
...
مُتحقق Almadar مثل مهندس مرور يتحقق من:
