...
تخيل عالماً ما تحتاج فيه لكتابة آلاف الأسطر من الكود عشان تخلي روبوت يتحرك بذكاء. عالماً تُصرّح فيه عن سلوك الآلة بنفس الطريقة اللي تصف فيها حركة الكواكب في مداراتها.

هذا هو عالم **Almadar**.

في هذه السلسلة، رح نستكشف كيف يمكن لـ Almadar أن تُحدث ثورة في مجال الروبوتات والأتمتة الصناعية، وكيف يمكن للعالم العربي أن يقود هذا التحول.

<!-- truncate -->

---

## المشكلة: ليش برمجة الروبوتات صعبة؟

### الطريقة التقليدية

لما يبرمج المهندسون روبوت اليوم، يواجهون تحديات كبيرة:
...
- القوانين **تحكم** متى يمكن الـ transition
...
3. **الـ guards تحمي** — ما يمكن الإمساك بوزن أكبر من ٥٠
...
لما يُرسل التوصيل حدث `تم_التسليم`، يستمع التواصل ويُرسل تأكيد للعميل تلقائياً.
...
2. **احجز عرضاً** — نُريك Almadar على مشروعك
...
> **"الآلات ما عادت تحتاج لآلاف الأسطر. تحتاج لـ traits واضحة ومحددة."**

Almadar مو بس لغة برمجة. هو طريقة جديدة للتفكير في سلوك الآلات. طريقة تخلي البرمجة أقرب للفيزياء، والتطوير أقرب للتصميم.
...
[الجزء الثاني: بناء متحكم روبوت صناعي](/ar/blog/machines-with-traits-part-2) — رح نبني مع بعض ذراع روبوتية كاملة بـ Almadar، خطوة بخطوة.
