...
مبرمجك الذكي الثنائي لديه حد 200 ألف رمز. بعد 3 ساعات، أنت عند 150 ألف. ماذا تفعل؟
...
ضغط السياق يقلل استخدام الرموز بذكاء مع الحفاظ على المعنى الدلالي:
...
ضغط السياق في Almadar يتبع خط أنابيب من 8 خطوات:
...
ضغط السياق يشبه الملخص التنفيذي:
...
المدير التنفيذي لا يقرأ 500 صفحة. يقرأ الملخص وآخر التحديثات.

النماذج اللغوية تعمل بنفس الطريقة.
