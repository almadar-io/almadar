...
## الطلب الأصلي
طلب المستخدم توليد مخطط مداري لتطبيق إدارة مهام...

## الإجراءات المتخذة
1. إنشاء مخطط `taskly.orb` مع 3 مدارات
2. التحقق — إصلاح 4 أخطاء
3. التصريف إلى قالب TypeScript
4. طلب المستخدم إضافة حقل "الأولوية"

## الحالة الحالية
- المخطط صالح ويُصرَّف بنجاح
- مجلد العمل: /home/user/projects/taskly
```

## خط أنابيب الضغط

ضغط السياق في المدار يتبع خط أنابيب من 8 خطوات:
...
```
الساعة 1:
- إنشاء كيانات Order, Product, User
- إعداد سمات CRUD
- التصريف بنجاح
[الرسائل: 15، الرموز: ~8 آلاف]

الساعة 2:
- إضافة مدار عربة التسوق
- تنفيذ تدفق الدفع
- إصلاح أخطاء التحقق
...
1. تصفح المنتجات (نمط entity-table)
