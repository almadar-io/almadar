...
يسعدنا نقدم لكم **Almadar** - فيزياء البرمجيات.

Almadar هو إطار عمل تصريحي لبناء تطبيقات متكاملة من خلال state machines (أنظمة تتحكم بسلوك البرنامج عبر حالات محددة). عرّف الـ entities (نماذج البيانات) والسلوكيات والواجهة كـ schemas تُترجم إلى كود جاهز للإنتاج.

<!-- truncate -->

## ما هو Almadar؟

Almadar يجلب نموذج جديد لتطوير البرمجيات:
...
مستعد تجرب Almadar؟ اطلع على [التوثيق](/ar/docs) للبدء، أو [حمّل CLI](/ar/docs/downloads/cli) لإنشاء مشروعك الأول.
