...
الآن هناك بالضبط **5 حالات** و **9 transitions صالحة**. لا تركيبات مستحيلة.
...
الواقع: مطورو الألعاب يستخدمون finite state machines (آلات حالة محدودة) لأنها **تعمل**. الواجهات مثل الألعاب تماماً: إجراءات المستخدم تُفعّل تغييرات في الحالة.
...
في Almadar، لا تُنفّذ الـ state machine — بل **تُصرّح** عنها:
...
Almadar يجعل الـ state machines هي الخيار الافتراضي، لا الاستثناء. لأن مستخدميك يستحقون برمجيات متوقعة.
